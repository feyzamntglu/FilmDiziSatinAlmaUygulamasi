...
{
    public partial class FilmListele : MaterialForm
    {
        public FilmListele()
        {
            InitializeComponent();
        ...
        private void datagridFilm_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FilmAyrıntı frm = new FilmAyrıntı();
            ...
            frm.resim = datagridFilm.Rows[secilen].Cells[5].Value.ToString();
            frm.fragman= datagridFilm.Rows[secilen].Cells[6].Value.ToString();
            frm.dil = datagridFilm.Rows[secilen].Cells[7].Value.ToString();
            frm.kategori = datagridFilm.Rows[secilen].Cells[8].Value.ToString();
